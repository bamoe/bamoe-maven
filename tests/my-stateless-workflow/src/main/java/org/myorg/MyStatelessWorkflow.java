...
@ApplicationScoped
public class MyStatelessWorkflow extends RuleEngineAdaptor {

    private static final Logger logger = LoggerFactory.getLogger(MyStatelessWorkflow.class);
    private static final String RULESET_NAME = "my-stateless-workflow";
