# IBM Business Automation Manager Open Editions (BAMOE) - Decision Service Archetype
...
```shell
mvn archetype:generate -B "-DarchetypeGroupId=com.ibm.bamoe.maven.archetypes" "-DarchetypeArtifactId=decision-service-archetype" "-DarchetypeVersion=9.2.1" \
  "-DprojectName=$1" \
  "-DartifactId=$1" \
...
```shell
./bamoe-maven/scripts/create-decision-servce.sh my-decision-service my-fact-model
```
...
| projectDescription | String | Project description | BAMOE Kogito Decision Service | No |
