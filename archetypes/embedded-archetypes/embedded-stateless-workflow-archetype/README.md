# IBM Business Automation Manager Open Editions (IBM BAMOE) - Embedded Stateless Workflow Archetype
This repository contains a custom [**Maven Archetype**](https://maven.apache.org/guides/introduction/introduction-to-archetypes.html) used for creating an embedded stateless workrlow project
...
```shell
mvn archetype:generate -B "-DarchetypeGroupId=com.ibm.bamoe.maven.archetypes" "-DarchetypeArtifactId=bamoe-embedded-stateless-workflow-archetype" "-DarchetypeVersion=9.3.0-ibm-0007" \
  "-DprojectName=$1" \
  "-DartifactId=$1"
```
