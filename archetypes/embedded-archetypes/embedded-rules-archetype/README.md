# IBM Business Automation Manager Open Editions (IBM BAMOE) - Embedded Rules Archetype
This repository contains a custom [**Maven Archetype**](https://maven.apache.org/guides/introduction/introduction-to-archetypes.html) used for creating an embedded rules project
