# IBM Business Automation Manager Open Editions (IBM BAMOE) - STP Orchestration Service Archetype
...
./bamoe-maven/scripts/create-stp-servce.sh my-stp-service "-DuseFactModel=true -DfactModelGroupId=com.ibm.edu.bamoe -DfactModelArtifactId=my-fact-model -DfactModelVersion=1.0.0-SNAPSHOT"
```
