...
### Quarkus Runtime
```shell
mvn archetype:generate -B "-DarchetypeGroupId=com.ibm.techsales.bamoe.maven.archetypes" "-DarchetypeArtifactId=classic-decision-service-archetype"
  "-DarchetypeVersion=9.3.0" \
...
### Quarkus Runtime
```shell
./bamoe-maven/scripts/create-quarkus-classic-decision-servce.sh my-classic-decision-service
./bamoe-maven/scripts/create-quarkus-classic-decision-servce.sh my-classic-decision-service "-DuseFactModel=true -DfactModelGroupId=com.ibm.techsales.bamoe -DfactModelArtifactId=my-fact-model -DfactModelVersion=1.0.0-SNAPSHOT"
```

### Spring Boot Runtime
```shell
./bamoe-maven/scripts/create-springboot-classic-decision-servce.sh my-classic-decision-service
./bamoe-maven/scripts/create-springboot-classic-decision-servce.sh my-classic-decision-service "-DuseFactModel=true -DfactModelGroupId=com.ibm.techsales.bamoe -DfactModelArtifactId=my-fact-model -DfactModelVersion=1.0.0-SNAPSHOT"
...
./bamoe-maven/scripts/create-classic-decision-servce.sh my-classic-decision-service "-DuseFactModel=true -DfactModelGroupId=com.ibm.techsales.bamoe -DfactModelArtifactId=my-fact-model -DfactModelVersion=1.0.0-SNAPSHOT"
```
...
| factModelGroupId | String | Maven groupId for fact model project | com.ibm.techsales.bamoe | No |
...
| bamoeVersion | String | Maven Version for BAMOE Libraries | 9.3.0-ibm-0007 | No |
| bamoeRuntime | String | BAMOE Runtime Library | quarkus | No |
| bamoeSubscription | String | dmoe | No |
...
| quarkusRuntimeVersion | String | Maven Version for the Quarkus Runtime | 3.4.9 | No |
| quarkusPlugin | String | Quarkus Plugin | quarkus-maven-plugin | No |
| springbootRuntimeGroupId | String | Maven GroupID for the Spring Boot Runtime | org.springframework.boot | No |
| springbootRuntimeArtifactId | String | Maven ArtifactID for the Spring Boot Runtime | spring-boot-dependencies | No |
| springbootRuntimeVersion | String | Maven Version for the Spring Boot Runtime | 3.20.2.2 | No |
| springbootPlugin | String | Spring Boot Plugin | spring-boot-maven-plugin | No |
...
| ocpContainerImageRegistry | String | Name of the openshift image repository | ****** | No |
