...
mvn archetype:generate -B "-DarchetypeGroupId=com.ibm.edu.bamoe.maven.archetypes" "-DarchetypeArtifactId=stp-orchestration-service-archetype" "-DarchetypeVersion=9.3.0" \
  "-DprojectName=$1" \
  "-DartifactId=$1" $2