...
mvn archetype:generate -B "-DarchetypeGroupId=com.ibm.techsales.bamoe.maven.archetypes" "-DarchetypeArtifactId=process-service-archetype" "-DarchetypeVersion=9.3.0" \
  "-DprojectName=$1" \
  "-DartifactId=$1" $2